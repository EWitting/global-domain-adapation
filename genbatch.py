...
batch_path = os.path.join(os.getcwd(), 'results', 'v3_concept_weak_val')

init_classification = dict(n_samples=10000, n_features=5, n_informative=3,
                           n_repeated=0, n_redundant=2, n_clusters_per_class=4)

shifter = Shifter(n_domains=4, rot=0, trans=2, scale=0)
